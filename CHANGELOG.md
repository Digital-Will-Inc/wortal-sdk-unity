...
## [6.2.2] - 2025-08-27
### Changed
- Update Wortal SDK Icon
### Fixed
- Register Unity Localization as Dependencies
...
### Fixed
- Context
  - Switch payload now serialized properly
...
### Fixed
- Context
    - Facebook rejects context.shareAsync if shareDestination in payload is an empty array
...
### Added
- Core
  - Template for portrait mode games

### Fixed
- Core
  - IsInitialized now checks a flag from the Unity SDK instead of SDK Core
