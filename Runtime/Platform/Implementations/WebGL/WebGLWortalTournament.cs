...
namespace DigitalWill.WortalSDK
{
    public class WebGLWortalTournament : IWortalTournament
    {
        ...
        {
            Debug.Log("[WebGL Platform] IWortalTournament.GetCurrent() called - Not implemented");
        ...
        {
            Debug.Log("[WebGL Platform] IWortalTournament.GetAll() called - Not implemented");
            errorCallback?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on WebGL platform",
        ...
        {
            Debug.Log($"[WebGL Platform] IWortalTournament.PostScore({score}) called - Not implemented");
            errorCallback?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on WebGL platform",
        ...
        {
            Debug.Log($"[WebGL Platform] IWortalTournament.Create({payload}) called - Not implemented");
            errorCallback?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on WebGL platform",
        ...
        {
            Debug.Log($"[WebGL Platform] IWortalTournament.Share({payload}) called - Not implemented");
            errorCallback?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on WebGL platform",
        ...
        {
            Debug.Log($"[WebGL Platform] IWortalTournament.Join({tournamentID}) called - Not implemented");
            errorCallback?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on WebGL platform",
