...
namespace DigitalWill.WortalSDK
{
    public class WebGLWortalStats : IWortalStats
    {
        ...
        {
            Debug.Log($"[WebGL Platform] IWortalStats.GetStats({level}, {payload}) called - Not implemented");
        ...
        {
            Debug.Log($"[WebGL Platform] IWortalStats.PostStats({level}, {value}, {payload}) called - Not implemented");
            errorCallback?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on WebGL platform",
