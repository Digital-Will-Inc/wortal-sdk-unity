...
namespace DigitalWill.WortalSDK
{
    public class AndroidWortalLeaderboard : IWortalLeaderboard
    {
        ...
        {
            Debug.Log($"[Android Platform] IWortalLeaderboard.GetLeaderboardAsync({name}) called - Not implemented");
        ...
        {
            Debug.Log($"[Android Platform] IWortalLeaderboard.SendScoreAsync({name}, {score}) called - Not implemented");
            onError?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on Android platform",
        ...
        {
            Debug.Log($"[Android Platform] IWortalLeaderboard.SendScoreAsync({name}, {score}, {details}) called - Not implemented");
            onError?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on Android platform",
        ...
        {
            Debug.Log($"[Android Platform] IWortalLeaderboard.GetEntriesAsync({name}, {count}, {offset}) called - Not implemented");
            onError?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on Android platform",
        ...
        {
            Debug.Log($"[Android Platform] IWortalLeaderboard.GetPlayerEntryAsync({name}) called - Not implemented");
            onError?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on Android platform",
        ...
        {
            Debug.Log($"[Android Platform] IWortalLeaderboard.GetEntryCountAsync({name}, {count}) called - Not implemented");
            onError?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on Android platform",
        ...
        {
            Debug.Log($"[Android Platform] IWortalLeaderboard.GetConnectedPlayerEntriesAsync({name}, {count}, {offset}) called - Not implemented");
            onError?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on Android platform",
