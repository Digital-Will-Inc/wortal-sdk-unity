...
namespace DigitalWill.WortalSDK
{
    public class iOSWortalLeaderboard : IWortalLeaderboard
    {
        ...
        {
            Debug.Log($"[iOS Platform] IWortalLeaderboard.GetLeaderboardAsync({name}) called - Not implemented");
        ...
        {
            Debug.Log($"[iOS Platform] IWortalLeaderboard.SendScoreAsync({name}, {score}) called - Not implemented");
            onError?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on iOS platform",
        ...
        {
            Debug.Log($"[iOS Platform] IWortalLeaderboard.SendScoreAsync({name}, {score}, {details}) called - Not implemented");
            onError?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on iOS platform",
        ...
        {
            Debug.Log($"[iOS Platform] IWortalLeaderboard.GetEntriesAsync({name}, {count}, {offset}) called - Not implemented");
            onError?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on iOS platform",
        ...
        {
            Debug.Log($"[iOS Platform] IWortalLeaderboard.GetPlayerEntryAsync({name}) called - Not implemented");
            onError?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on iOS platform",
        ...
        {
            Debug.Log($"[iOS Platform] IWortalLeaderboard.GetEntryCountAsync({name}, {count}) called - Not implemented");
            onError?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on iOS platform",
        ...
        {
            Debug.Log($"[iOS Platform] IWortalLeaderboard.GetConnectedPlayerEntriesAsync({name}, {count}, {offset}) called - Not implemented");
            onError?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on iOS platform",
