...
{
    public class iOSWortalIAP : IWortalIAP
    {
        public bool IsSupported => false;

        public void GetCatalogAsync(Action<Product[]> onSuccess, Action<WortalError> onError)
        {
            Debug.Log("[iOS Platform] IWortalIAP.GetCatalogAsync() called - Not implemented");
        ...
        {
            Debug.Log("[iOS Platform] IWortalIAP.GetPurchasesAsync() called - Not implemented");
            onError?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on iOS platform",
        ...
        {
            Debug.Log($"[iOS Platform] IWortalIAP.MakePurchaseAsync({purchaseConfig}) called - Not implemented");
            onError?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on iOS platform",
        ...
        {
            Debug.Log($"[iOS Platform] IWortalIAP.ConsumePurchaseAsync({token}) called - Not implemented");
            onError?.Invoke(new WortalError
            {
                Code = "NOT_IMPLEMENTED",
                Message = "Not implemented on iOS platform",
