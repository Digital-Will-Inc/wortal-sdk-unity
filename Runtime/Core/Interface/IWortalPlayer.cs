...
namespace DigitalWill.WortalSDK.Core
{
    ...
    public interface IWortalPlayer
    {
        ...
        void GetConnectedPlayersAsync(ConnectedPlayersPayload payload, Action<ConnectedPlayer[]> onSuccess, Action<WortalError> onError);
        ...
        /// <param name="onError">Callback for retrieval errors</param>
        void GetSignedPlayerInfoAsync(Action<SignedPlayerInfo> onSuccess, Action<WortalError> onError);

        /// <summary>
        /// Gets the player's signed info with request payload
        /// </summary>
        /// <param name="payload">Signed info request payload</param>
        /// <param name="onSuccess">Callback with signed player info</param>
        /// <param name="onError">Callback for retrieval errors</param>
        void GetSignedInfoAsync(SignedPlayerInfoPayload payload, Action<SignedPlayerInfo> onSuccess, Action<WortalError> onError);
